 ...
 * @author rafhi
 */
public class VentanaRecuperarB extends javax.swing.JInternalFrame {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(VentanaRecuperarB.class.getName());

    /**
     * Creates new form VentanaRecuperar
     */
    public VentanaRecuperarB() {
        initComponents();
   ...
   String userText = txtUsuario.getText().trim();
     if (userText.isEmpty() || userText.equals("Usuario")) {
         JOptionPane.showMessageDialog(this, "Por favor, ingresa tu nombre de usuario.", "Campo vacío", JOptionPane.WARNING_MESSAGE);
         return; 
     }
     ...
     try (java.sql.PreparedStatement pst = con.prepareStatement(sql)) {
         ...
         try (java.sql.ResultSet rs = pst.executeQuery()) {
             if (rs.next()) {
                 ...
                 if (desktop != null) {
                     versionbeta.VentanaRecuperar2_PreguntaB paso2 = new versionbeta.VentanaRecuperar2_PreguntaB();
                     paso2.configurarDatos(userText, preguntaDB);
                     desktop.add(paso2);
                     paso2.setVisible(true);
                     paso2.setSize(400, 300);
                     paso2.setLocation((desktop.getWidth() - paso2.getWidth()) / 2, (desktop.getHeight() - paso2.getHeight()) / 2);
                 }
                 this.dispose(); 
             } else {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(() -> new VentanaRecuperarB().setVisible(true));
    }
