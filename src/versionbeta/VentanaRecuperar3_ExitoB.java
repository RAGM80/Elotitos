 ...
 * @author rafhi
 */
public class VentanaRecuperar3_ExitoB extends javax.swing.JInternalFrame {
    boolean passVisible = false;
    private String passwordReal; 
    private static final java.util.logging.Logger logger = 
    java.util.logging.Logger.getLogger(VentanaRecuperar3_ExitoB.class.getName());

    /**
     * Creates new form VentanaRecuperar3_Exito
     */
    public VentanaRecuperar3_ExitoB() {
        initComponents();
    }

    public VentanaRecuperar3_ExitoB(String contrasena) {
...
public void mostrarContrasenaRecuperada(String passwordReal) {
    ...
    javax.swing.JDesktopPane desktop = this.getDesktopPane();
        if (desktop != null) {
            ...
            versionbeta.VentanaLoginB login = new versionbeta.VentanaLoginB(principal);
            desktop.add(login);
...
java.awt.EventQueue.invokeLater(() -> new VentanaRecuperar3_ExitoB("test").setVisible(true));
    }
